...
<%
	...
	base = "ABCDEFGHIJKLMNPQRST1234567889";//英文验证码
	//备选汉字的长度
	...
	//备选字体
	String[] fontTypes = { "Times New Roman", "Arial", "Verdana", "Georgia", "Courier New","Comic Sans MS","Trebuchet MS","Impact" };
	...
	//将认证码小写存入session
	session.setAttribute("hy.vcode", sRand.toLowerCase());
	g.dispose();
	//输出图象到页面
