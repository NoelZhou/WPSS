    ...
    <div class="main_box clearfix">
        ...
        <div class="right_main_div">
            <div class="W_width">
				...
				<input type="hidden" id="create_user" name="create_user" value="190"/>
				</c:if>
				<c:if test="${roleAll.role_name!=null}">
                ...
                <p class="P_Label clearfix input_style">
                	角色名称<input type="text" id="role_name" name="role_name" value="${roleAll.role_name}"></input>
                 	...
                 	<span><a class="a_size01" onclick="save()" style="cursor: pointer;">保存</a></span>
                </p>
                ...
                <!-- table内容 -->
                <div class="table_box">
                    <p style="line-height: 30px; margin-bottom: 12px;">权限</p>
                    <table id="table">
                        <thead>
                            <tr>
