...
<body>
	...
	<div class="main_box clearfix">
		...
		<div class="right_main_div0">
			<div class="W_width">
				<!-- 编辑标签 -->
				<form class="P_Label" action="" id="Form" method="post"
					enctype="multipart/form-data">
					<input type='text' name='textfield' id='textfield' class='txt' />
					<input type='button' class='btn' value='浏览...' /> <input
						type="file" name="fileField" class="file" style="cursor: pointer;"
						id="fileField" size="28"
						onchange="document.getElementById('textfield').value=this.value" />
					<input type="button" name="button" onclick="importXml()"
						class="btn" style="cursor: pointer;" value="开始解析" />
