	...
	$.ajax({
		...
		success:function(data){
			...
			for(var i = 0;i < varlist.length;i++){
				str +="<tbody>"
				+"<tr>"
				+"<td style='width:50px;'>"+(i+1)+"</td><td>"+varlist[i].addr+"</td><td>"+varlist[i].name+"</td><td> <label class='label_input padding_style'><input type='checkbox' class='input_chk' name='ids' value='"+varlist[i].id+"'"
	...
	<div class="main_box clearfix">
		...
		<div class="right_main_div0">
			<div class="W_width">
				...
				<!-- table内容 -->
				<a class="A_button"
					style="cursor: pointer; margin-bottom: 10px; margin-top: 10px; float: left;"
					onclick="save();">保存</a>
