...
public class WindPowerReadModbusXmlAll_hsfd2 {
	// 主表
	String apptab = "windpower_basedataset";
	...
	public static void main(String[] args) {
		new WindPowerReadModbusXmlAll_hsfd2().ReadModbusXmlall(null);
	}
	/**
	 * 读协议的所有xml文件
	 * @param filePath
...
//		   	String xmlpath1 = this.getClass().getClassLoader().getResource("").getPath()+ "xmlconfig/modbustcp/双馈/通讯协议定义控制参数数组xml解析文件--读写参数";
			String xmlpath1 = "C:/Users/Administrator/Desktop/双馈--基本参数原始数据库/通讯协议定义控制参数数组xml解析文件--只读参数";
